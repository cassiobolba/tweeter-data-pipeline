...
# 0 means today, -1 means today and yesterday
try:
    files = []
...
try:
    ...
    df.to_csv(rf"C:\Users\cassi\Desktop\Tweeter_Case\consumerZone\FlixbusData\flixBusData_{today}.csv"
            , encoding = 'utf-8-sig')
    dfHashtags.to_csv(rf"C:\Users\cassi\Desktop\Tweeter_Case\consumerZone\Hasgtags\flixBusHastags_{today}.csv"
            , encoding = 'utf-8')
